...
#define DEFAULT__1005__SYNC_GEN							CO_SYNC_NOT_GEN /*CO_SYNC_GEN*/		/*	Producer sync: Set CO_SYNC_GEN            -> For PMU/BSS_MASTER
...
#define DEFAULT__180000__TPDO1_ENABLE						CO_PDO_VALID	//<< Set CO_PDO_VALID if used, otherwise, set CO_PDO_NOT_VALID
#define DEFAULT__180001__TPDO1_TRANS_TYPE					(9)				//<< Set according to synchronous scheduled.
...
#define DEFAULT__180005__TPDO1_SYNC_MASK_REGISTER			(0x00000FFF)		//<< Set according to synchronous scheduled, default: 0x00000000
...
#define DEFAULT__180100__TPDO2_ENABLE						CO_PDO_VALID	//<< Set CO_PDO_VALID if used, otherwise, set CO_PDO_NOT_VALID
#define DEFAULT__180101__TPDO2_TRANS_TYPE					(10)				//<< Set according to synchronous scheduled.
...
#define DEFAULT__180105__TPDO2_SYNC_MASK_REGISTER			(0x00000FFF)		//<< Set according to synchronous scheduled, default: 0x00000000
...
#define DEFAULT__180200__TPDO3_ENABLE						CO_PDO_VALID	//<< Set CO_PDO_VALID if used, otherwise, set CO_PDO_NOT_VALID
#define DEFAULT__180201__TPDO3_TRANS_TYPE					(11)				//<< Set according to synchronous scheduled.
																				//	 Detail: See CO__TPDO.h >> TPDO transmission Types
...
#define DEFAULT__180205__TPDO3_SYNC_MASK_REGISTER			(0x00000FFF)		//<< Set according to synchronous scheduled, default: 0x00000000
...
#define DEFAULT__180300__TPDO4_ENABLE						CO_PDO_VALID	//<< Set CO_PDO_VALID if used, otherwise, set CO_PDO_NOT_VALID
#define DEFAULT__180301__TPDO4_TRANS_TYPE					(12)				//<< Set according to synchronous scheduled.
																				//	 Detail: See CO__TPDO.h >> TPDO transmission Types
...
#define DEFAULT__180305__TPDO4_SYNC_MASK_REGISTER			(0x00000FFF)		//<< Set according to synchronous scheduled, default: 0x00000000
#define DEFAULT__180306__TPDO4_BUILD_DATA_OPTION			(CO_TPDO_build_data_manually)					//<< Default: CO_TPDO_build_data_manually
																				//see TPDO.h/CO_TPDO_Build_Data_option_t
/* TPDO5 Communication Parameter*/
#define DEFAULT__180300__TPDO5_ENABLE                       CO_PDO_VALID    //<< Set CO_PDO_VALID if used, otherwise, set CO_PDO_NOT_VALID
#define DEFAULT__180301__TPDO5_TRANS_TYPE                   (13)                //<< Set according to synchronous scheduled.
//   Detail: See CO__TPDO.h >> TPDO transmission Types
#define DEFAULT__180302__TPDO5_MAX_INHIBIT_TIME_MS          (1000)              /*  (16 bit). Suggest default = 1000. Valid when setting TPDO in event mode*/
#define DEFAULT__180303__TPDO5_EVENT_TIME_MS                (10000)             /*  (16 bit). Suggest default = 10000. Valid when setting TPDO in event mode*/
#define DEFAULT__180305__TPDO5_SYNC_MASK_REGISTER           (0x00000FFF)        //<< Set according to synchronous scheduled, default: 0x00000000
#define DEFAULT__180306__TPDO5_BUILD_DATA_OPTION            (CO_TPDO_build_data_manually)                   //<< Default: CO_TPDO_build_data_manually

/* TPDO5 Communication Parameter*/
#define DEFAULT__180300__TPDO6_ENABLE                       CO_PDO_VALID    //<< Set CO_PDO_VALID if used, otherwise, set CO_PDO_NOT_VALID
#define DEFAULT__180301__TPDO6_TRANS_TYPE                   (14)                //<< Set according to synchronous scheduled.
//   Detail: See CO__TPDO.h >> TPDO transmission Types
#define DEFAULT__180302__TPDO6_MAX_INHIBIT_TIME_MS          (1000)              /*  (16 bit). Suggest default = 1000. Valid when setting TPDO in event mode*/
#define DEFAULT__180303__TPDO6_EVENT_TIME_MS                (10000)             /*  (16 bit). Suggest default = 10000. Valid when setting TPDO in event mode*/
#define DEFAULT__180305__TPDO6_SYNC_MASK_REGISTER           (0x00000FFF)        //<< Set according to synchronous scheduled, default: 0x00000000
#define DEFAULT__180306__TPDO6_BUILD_DATA_OPTION            (CO_TPDO_build_data_manually)                   //<< Default: CO_TPDO_build_data_manually

/* TPDO5 Communication Parameter*/
#define DEFAULT__180300__TPDO7_ENABLE                       CO_PDO_VALID    //<< Set CO_PDO_VALID if used, otherwise, set CO_PDO_NOT_VALID
#define DEFAULT__180301__TPDO7_TRANS_TYPE                   (15)                //<< Set according to synchronous scheduled.
//   Detail: See CO__TPDO.h >> TPDO transmission Types
#define DEFAULT__180302__TPDO7_MAX_INHIBIT_TIME_MS          (1000)              /*  (16 bit). Suggest default = 1000. Valid when setting TPDO in event mode*/
#define DEFAULT__180303__TPDO7_EVENT_TIME_MS                (10000)             /*  (16 bit). Suggest default = 10000. Valid when setting TPDO in event mode*/
#define DEFAULT__180305__TPDO7_SYNC_MASK_REGISTER           (0x00000FFF)        //<< Set according to synchronous scheduled, default: 0x00000000
#define DEFAULT__180306__TPDO7_BUILD_DATA_OPTION            (CO_TPDO_build_data_manually)                   //<< Default: CO_TPDO_build_data_manually
...
//    },
    ...
    /* TPDO1 Communication Parameter*/
          ...
          { .id =
          { .node_id = NODE_ID_DEFAULT, .func_code = CO_CAN_ID_TPDO_1 >> 7, .reverse1 = 0, .bit_frame =
                    CO_BIT_CAN_FRAME_11BIT,
            .bit_30 = CO_BIT_RTR_NOT_ALLOW, .valid = DEFAULT__180000__TPDO1_ENABLE },
            .transmission_type = DEFAULT__180001__TPDO1_TRANS_TYPE, .max_inhibit_time_ms =
                    DEFAULT__180002__TPDO1_MAX_INHIBIT_TIME_MS,
            .max_event_time_ms = DEFAULT__180003__TPDO1_EVENT_TIME_MS, .sync_start_value = 0,				//<< ignored
            .sync_mask_reg = DEFAULT__180005__TPDO1_SYNC_MASK_REGISTER, .build_data_option =
                    DEFAULT__180006__TPDO1_BUILD_DATA_OPTION, },
          /* TPDO2 Communication Parameter*/
          .x180x_tpdo_comm_para[1] =
          {				//<< EDITABLE:
                  .id =
                  { .node_id = NODE_ID_DEFAULT, .func_code = CO_CAN_ID_TPDO_2 >> 7, .reverse1 = 0, .bit_frame =
                            CO_BIT_CAN_FRAME_11BIT,
                    .bit_30 = CO_BIT_RTR_NOT_ALLOW, .valid = DEFAULT__180100__TPDO2_ENABLE },
                  .transmission_type = DEFAULT__180101__TPDO2_TRANS_TYPE, .max_inhibit_time_ms =
                          DEFAULT__180102__TPDO2_MAX_INHIBIT_TIME_MS,
                  .max_event_time_ms = DEFAULT__180103__TPDO2_EVENT_TIME_MS, .sync_start_value = 0,			//<< ignored
                  .sync_mask_reg = DEFAULT__180105__TPDO2_SYNC_MASK_REGISTER, .build_data_option =
                          DEFAULT__180106__TPDO2_BUILD_DATA_OPTION, },
          /* TPDO3 Communication Parameter*/
          .x180x_tpdo_comm_para[2] =
          {				//<< EDITABLE:
                  .id =
                  { .node_id = NODE_ID_DEFAULT, .func_code = CO_CAN_ID_TPDO_3 >> 7, .reverse1 = 0, .bit_frame =
                            CO_BIT_CAN_FRAME_11BIT,
                    .bit_30 = CO_BIT_RTR_NOT_ALLOW, .valid = DEFAULT__180200__TPDO3_ENABLE },
                  .transmission_type = DEFAULT__180201__TPDO3_TRANS_TYPE, .max_inhibit_time_ms =
                          DEFAULT__180202__TPDO3_MAX_INHIBIT_TIME_MS,
                  .max_event_time_ms = DEFAULT__180203__TPDO3_EVENT_TIME_MS, .sync_start_value = 0,			//<< ignored
                  .sync_mask_reg = DEFAULT__180205__TPDO3_SYNC_MASK_REGISTER, .build_data_option =
                          DEFAULT__180206__TPDO3_BUILD_DATA_OPTION, },
          /* TPDO4 Communication Parameter*/
          .x180x_tpdo_comm_para[3] =
          {				//<< EDITABLE:
                  .id =
                  { .node_id = NODE_ID_DEFAULT, .func_code = CO_CAN_ID_TPDO_4 >> 7, .reverse1 = 0, .bit_frame =
                            CO_BIT_CAN_FRAME_11BIT,
                    .bit_30 = CO_BIT_RTR_NOT_ALLOW, .valid = DEFAULT__180300__TPDO4_ENABLE },
                  .transmission_type = DEFAULT__180301__TPDO4_TRANS_TYPE, .max_inhibit_time_ms =
                          DEFAULT__180302__TPDO4_MAX_INHIBIT_TIME_MS,
                  .max_event_time_ms = DEFAULT__180303__TPDO4_EVENT_TIME_MS, .sync_start_value = 0,			//<< ignored
                  .sync_mask_reg = DEFAULT__180305__TPDO4_SYNC_MASK_REGISTER, .build_data_option =
                          DEFAULT__180306__TPDO4_BUILD_DATA_OPTION, },
          /* TPDO5 Communication Parameter*/
          .x180x_tpdo_comm_para[4] =
          {             //<< EDITABLE:
                  .id =
                  { .node_id = NODE_ID_DEFAULT, .func_code = 0x200 >> 7, .reverse1 = 0, .bit_frame =
                  CO_BIT_CAN_FRAME_11BIT,
                    .bit_30 = CO_BIT_RTR_NOT_ALLOW, .valid = DEFAULT__180300__TPDO4_ENABLE },
                  .transmission_type = DEFAULT__180301__TPDO5_TRANS_TYPE, .max_inhibit_time_ms =
                  DEFAULT__180302__TPDO5_MAX_INHIBIT_TIME_MS,
                  .max_event_time_ms = DEFAULT__180303__TPDO5_EVENT_TIME_MS, .sync_start_value = 0,         //<< ignored
                  .sync_mask_reg = DEFAULT__180305__TPDO5_SYNC_MASK_REGISTER, .build_data_option =
                  DEFAULT__180306__TPDO5_BUILD_DATA_OPTION, },
          /* TPDO5 Communication Parameter*/
          .x180x_tpdo_comm_para[5] =
          {             //<< EDITABLE:
                  .id =
                  { .node_id = NODE_ID_DEFAULT, .func_code = 0x300 >> 7, .reverse1 = 0, .bit_frame =
                  CO_BIT_CAN_FRAME_11BIT,
                    .bit_30 = CO_BIT_RTR_NOT_ALLOW, .valid = DEFAULT__180300__TPDO4_ENABLE },
                  .transmission_type = DEFAULT__180301__TPDO6_TRANS_TYPE, .max_inhibit_time_ms =
                  DEFAULT__180302__TPDO6_MAX_INHIBIT_TIME_MS,
                  .max_event_time_ms = DEFAULT__180303__TPDO6_EVENT_TIME_MS, .sync_start_value = 0,         //<< ignored
                  .sync_mask_reg = DEFAULT__180305__TPDO6_SYNC_MASK_REGISTER, .build_data_option =
                  DEFAULT__180306__TPDO6_BUILD_DATA_OPTION, },
          /* TPDO5 Communication Parameter*/
          .x180x_tpdo_comm_para[6] =
          {             //<< EDITABLE:
                  .id =
                  { .node_id = NODE_ID_DEFAULT, .func_code = 0x400 >> 7, .reverse1 = 0, .bit_frame =
                  CO_BIT_CAN_FRAME_11BIT,
                    .bit_30 = CO_BIT_RTR_NOT_ALLOW, .valid = DEFAULT__180300__TPDO4_ENABLE },
                  .transmission_type = DEFAULT__180301__TPDO7_TRANS_TYPE, .max_inhibit_time_ms =
                  DEFAULT__180302__TPDO7_MAX_INHIBIT_TIME_MS,
                  .max_event_time_ms = DEFAULT__180303__TPDO7_EVENT_TIME_MS, .sync_start_value = 0,         //<< ignored
                  .sync_mask_reg = DEFAULT__180305__TPDO7_SYNC_MASK_REGISTER, .build_data_option =
                  DEFAULT__180306__TPDO7_BUILD_DATA_OPTION, },
	...
	.x1A0x_tpdo_map_para[3] = {			//<< EDITABLE:
		...
		.app_object[7].w	= 0x00000000			//<< application object 8st
          ...
          /* TPDO7 Mapping Parameter */
          .x1A0x_tpdo_map_para[6] =
          {         //<< EDITABLE:
                  .object_number = 0x00,                 //<< number of mapped application objects in PDO
                  .app_object[0].w = 0x00000000,           //<< application object 1st
                  .app_object[1].w = 0x00000000,           //<< application object 2st
