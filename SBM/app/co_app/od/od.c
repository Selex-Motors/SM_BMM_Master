...
char serial[13] = "000000N1EB101";

uint8_t bms_state;

static CO_Sub_Object_Ext_Confirm_Func_t swich_sbp_state(void)
{
//    if (sm_sbp->_co_sv->sdo_server.tx_msg.id.node_id != NODE_ID_DEFAULT)
//    {
//        if (bms_state == 0)
//        {
//            sm_sbp_set_state (sm_sbp, SBP_ST_STANDBY);
//        }
//        if (bms_state == 2)
//        {
//            sm_sbp_set_state (sm_sbp, SBP_ST_CHARGING);
//        }
//        if (bms_state == 1)
//        {
//            sm_sbp_set_state (sm_sbp, SBP_ST_DISCHARGING);
//        }
//        return CO_EXT_CONFIRM_success;
//    }
    return CO_EXT_CONFIRM_abort;
}
static CO_Sub_Object_Ext_Confirm_Func_t set_assign(void)
{
//    if (sm_sbp_get_state (sm_sbp) == SBP_ST_ASSIGN)
//    {
//        sm_sbp_set_state (sm_sbp, SBP_ST_STANDBY);
//    }
...
CO_Sub_Object_Ext_t bms_state_switch =
{ .p_shadow_data = &bms_state, .confirm_func = swich_sbp_state
};

CO_Sub_Object_Ext_t bms_set_assign_success =
{
    .p_shadow_data = NULL, .confirm_func = set_assign
};

CO_Sub_Object bms_object[] =
{
{ (void*) serial, ODA_SDO_R, 13, &bms_set_assign_success, NULL },
  { (void*) &bms_state, ODA_SDO_RW, 1, &bms_state_switch, NULL }, };
...
static CO_Object co_od_list[]=
{
  ...
  { .index = 0x2003, .sub_number = 2, .subs = bms_object },
		/* USER CODE 2 the end ---------------------------------------------------------*/
